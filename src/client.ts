...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['COZMOAI_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['COZMOAI_LOG'] or 'warn' if it isn't set.
   */
...
export class Cozmoai {
   ...
   * @param {string} [opts.baseURL=process.env['COZMOAI_BASE_URL'] ?? https://v2-nova-api.prod.czmx.in/api/org/{org_id}] - Override the default base URL for the API.
  ...
  constructor({
    ...
    const options: ClientOptions = {
      ...
      orgID,
      ...opts,
      baseURL: baseURL || `https://v2-nova-api.prod.czmx.in/api/org/{org_id}`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? Cozmoai.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('COZMOAI_LOG'), "process.env['COZMOAI_LOG']", this) ??
      defaultLogLevel;
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://v2-nova-api.prod.czmx.in/api/org/{org_id}';
  }
  ...
  static CozmoaiError = Errors.CozmoaiError;
