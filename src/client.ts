...
export class Cozmoai {
   ...
   * @param {string} [opts.baseURL=process.env['COZMOAI_BASE_URL'] ?? https://v2-nova-api.prod.czmx.in/api/org/] - Override the default base URL for the API.
  ...
  constructor({
    ...
    const options: ClientOptions = {
      ...
      orgID,
      ...opts,
      baseURL: baseURL || `https://v2-nova-api.prod.czmx.in/api/org/`,
    };
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://v2-nova-api.prod.czmx.in/api/org/';
  }
