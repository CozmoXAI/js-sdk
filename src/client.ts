...
export class Cozmoai {
   ...
   * @param {string} [opts.baseURL=process.env['COZMOAI_BASE_URL'] ?? https://nova.prod.czmx.in/api/org/{org_id}] - Override the default base URL for the API.
  ...
  constructor({
    ...
    const options: ClientOptions = {
      ...
      orgID,
      ...opts,
      baseURL: baseURL || `https://nova.prod.czmx.in/api/org/{org_id}`,
    };
  ...
  #baseURLOverridden(): boolean {
    return this.baseURL !== 'https://nova.prod.czmx.in/api/org/{org_id}';
  }
