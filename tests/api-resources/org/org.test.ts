...
describe('resource org', () => {
  ...
  test.skip('listAuditLogs', async () => {
    const responsePromise = client.org.listAuditLogs('org_id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('listAuditLogs: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.org.listAuditLogs('org_id', { page: 0, size: 100 }, { path: '/_stainless_unknown_path' }),
  ...
  // Mock server tests are disabled
  test.skip('sendChatMessage: only required params', async () => {
    const responsePromise = client.org.sendChatMessage('org_id', { message: 'x' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('sendChatMessage: required and optional params', async () => {
    const response = await client.org.sendChatMessage('org_id', {
      message: 'x',
